...
现有手势识别在首次松键后等待约 300 毫秒判断第二次按下，因此上述五键单击会增加等待；快速连续两次单击将被识别为双击。左右键也不再走无双击时的原生透传路径。配置导入、可见映射及当前设备档案持久化已核对。2026-09-25，用户在配置完成后反馈“测试成功”，记录为本次 Global Speed 双击配置的实机反馈；不扩大为 Typeless 三模式或长期稳定性验收。
